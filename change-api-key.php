                        ...
                        <div class="card">
                            <div class="header">
                                ...
                                <div class="header-dropdown m-r--5">
                                    <button type="submit" name="submit" class="button button-rounded bg-blue waves-effect" onclick="return confirm('Are you sure want to update API Key?')">Update API Key</button>
                                </div>
                                <br>
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-2" style="margin-top: 16px;">
                                         ...
                                         <a href="change-api-key.php?generate=true"><button type="button" class="button button-rounded btn-offset bg-blue waves-effect">Generate</button></a>
