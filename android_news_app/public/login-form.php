            ...
            <div class="body">
                <form method="POST" id="form_validation">
                    <center>
                        ...
                        <br>
                        <div class="custom-padding1 uppercase"><?php echo $app_name; ?></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            <button class="button button-rounded btn-block bg-blue waves-effect" type="submit" name="btnLogin">LOGIN</button>
                        </div>
                    </div>
                </form>
            </div>
