...
<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($category_name) && empty($error['category_image'])) {
            ...
            // check update result
            if ($update_result) {
                $error['update_category'] = "<div class='alert alert-info corner-radius'>Changes saved...</div>";
            } else {
                $error['update_category'] = "<div class='alert alert-danger corner-radius'>Update Failed</div>";
            }
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div>
                                    ...
                                    <div class="col-sm-12">
                                         <button class="button button-rounded bg-blue waves-effect pull-right" type="submit" name="btnEdit">UPDATE</button>
                                    </div>
