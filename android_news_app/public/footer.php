        <div class="fixed-footer footer-padding">
          <div class="">
                <div class="copyright">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                           <ol>
                                ...
                                <li>Watch video tutorial <a href="https://www.youtube.com/embed/eAkyaEHMJUE" target="_blank">HERE</a></li>
                            </ol>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">OK, I AM UNDERSTAND</button>
                ...
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <img src="assets/images/admob_app_id.jpg" class="img-responsive">
                            <p><b>Important:</b> This step is required! Failure to add your sdk key in the string tag results may caused the app is not working properly.</p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal">OK, I AM UNDERSTAND</button>
                        </div>
