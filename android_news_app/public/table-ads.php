<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        $data = array(
            ...
            'applovin_mrec_ad_unit_id'    => $_POST['applovin_mrec_ad_unit_id'],
                                            ...
                                            <div style="padding-left: 15px; padding-right: 15px;">
                                                ...
                                                <select class="form-control show-tick" name="ad_type" id="ad_type">
                                                    ...
                                                    <?php } else if ($settings_row['ad_type'] == 'applovin') { ?>
                                                        ...
                                                        <option value="startapp">StartApp</option>
                                                        <option value="unity">Unity Ads</option>
                                                        <option value="applovin" selected="selected">AppLovin</option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div id="admob_ad_network">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                        ...
                                                        <a href="" data-toggle="modal" data-target="#modal-admob-app-id"><button class="button button-rounded bg-blue waves-effect">VIEW IMPLEMENTATION</button></a>
                                        ...
                                        <div id="applovin_ad_network">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                        ...
                                                        <a href="" data-toggle="modal" data-target="#modal-applovin-sdk-key"><button class="button button-rounded bg-blue waves-effect">VIEW IMPLEMENTATION</button></a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <div class="form-line">
                                                        <div class="font-12">AppLovin MREC Ad ID</div>
                                                        <input type="text" class="form-control" name="applovin_mrec_ad_unit_id" id="applovin_mrec_ad_unit_id" value="<?php echo $settings_row['applovin_mrec_ad_unit_id'];?>" required>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="body body-offset">
                        ...
                        <div class="row clearfix" style="padding-right: 10px;">
                            ...
                            <ol>
                                ...
                                <li>If you choose to use <b>Facebook Audience Network</b> Open Bidding, please select <b>Ad Network Type</b> to be <b>AdMob</b> or <b>AppLovin</b>, both Ad Networks support being a Mediation Partner although it's still a Beta version.</li>
                                <br>
                                ...
                                <li><b>AppLovin</b> doesn't support Native Ad formats, Native Ad will replaced with Medium Rectangle (MREC) Ad formats.</li><br>

                                <li><b>Unity Ads</b> doesn't support Native Ad formats, so will only show Banner and Interstitial ads.</li>
