<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $_SESSION['msg'] = "Notification template deleted successfully...";
                    ...
                    <div class="card corner-radius">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-notification.php"><button type="button" class="button button-rounded btn-offset bg-blue waves-effect">ADD NOTIFICATION</button></a>
                            </div>
                        </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group form-float">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="keyword" placeholder="Search notification...">
                                                </div>
                                            </div>
                                        </td>
