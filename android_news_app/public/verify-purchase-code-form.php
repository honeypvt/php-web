    ...
    if (isset($_POST['verify'])) {
        ...
        if (isset($envatoRes->item->name)) {
            ...
            if ($data['item_id'] != $var_item_id) {
                ...
                $result['show_button'] = '<button type="submit" name="submit" class="button button-rounded bg-blue btn-block btn-lg waves-effect">SUBMIT</button>';
            }
        } else { 
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand uppercase" href="verify-purchase-code.php"><?php echo $app_name; ?></a>
            </div>
