                    ...
                    <div class="card corner-radius">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <button type="submit" name="revoke_license" class="button button-rounded btn-offset bg-blue waves-effect" onclick="return confirm('Are you sure want to revoke this license?')">REVOKE LICENSE</button>
                            </div>
                        </div>
                        <div class="body">
